...
from infiltration_model.core.parameters import SoilParameters, HortonParams, GreenAmptParams
...
def simulate(
    ...
    infil_params: Union[HortonParams, GreenAmptParams]
) -> dict:
    """
    ...
    infiltration_model : 'horton' or 'green_ampt'
